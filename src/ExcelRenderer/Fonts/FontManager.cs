...
public sealed class FontManager : IFontManager
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FontManager"/> class. 必要な設定を使用して新しいインスタンスを初期化します.
    /// </summary>
    ...
    /// Register を実行します.
    /// </summary>
    /// <param name="family">family に渡す値です。</param>
    /// <param name="regular">regular に渡す値です。</param>
    /// <param name="bold">bold に渡す値です。</param>
    /// <param name="italic">italic に渡す値です。</param>
    /// <param name="boldItalic">boldItalic に渡す値です。</param>
